...
@RestController
@RequestMapping("/api/reservation-de-parking-kafka")
public class ReservationDeParkingKafkaResource {
    private final Logger log = LoggerFactory.getLogger(ReservationDeParkingKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ReservationDeParkingKafkaResource(KafkaProperties kafkaProperties) {
